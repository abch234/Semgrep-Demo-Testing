...
public class GreetingController {
  ...
  public String test4(@PathVariable String name) {
    // ruleid: jdbctemplate-sqli
    namedParameterJdbcTemplate.query("SELECT id, first_name, last_name FROM customers WHERE first_name = " + name);
    return "ok";
  }
  ...
  @GetMapping("/ok-test6")
  public String okTest6(@RequestBody String name, HttpServletResponse response) {
    // ok: jdbctemplate-sqli
    namedParameterJdbcTemplate.batchUpdate(String.format("INSERT INTO customers(first_name, last_name) VALUES (%s,foobar)", (name != null)));
    return "ok";
  }
}
